...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/features/featuresSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureFeaturesCols';
import _ from 'lodash';
import dataFormatter from '../../helpers/dataFormatter';

const perPage = 5;

const TableSampleFeatures = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (featuresNotify.showNotification) {
      notify(featuresNotify.typeNotification, featuresNotify.textNotification);
    }
  }, [featuresNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/features/features-view/?id=${id}`);
  };
...
export default TableSampleFeatures;
